...
INSERT INTO "new_AppConfiguration" ("activeAccountUuid", "autoManageJavaSystemProfiles", "concurrentDownloads", "defaultInstanceGroup", "deletionThroughRecycleBin", "discordIntegration", "downloadDependencies", "gameResolution", "nokiatisAccountStatus", "nokiatisAccountUuid", "id", "instancesGroupBy", "instancesGroupByAsc", "instancesSortBy", "instancesSortByAsc", "instancesTileSize", "isFirstLaunch", "javaCustomArgs", "language", "lastAppVersion", "launcherActionOnGameLaunch", "modChannels", "modPlatformBlacklist", "postExitHook", "preLaunchHook", "reducedMotion", "releaseChannel", "showAppCloseWarning", "showFeatured", "termsAndPrivacyAccepted", "termsAndPrivacyAcceptedChecksum", "theme", "wrapperCommand", "xms", "xmx") SELECT "activeAccountUuid", "autoManageJavaSystemProfiles", "concurrentDownloads", "defaultInstanceGroup", "deletionThroughRecycleBin", "discordIntegration", "downloadDependencies", "gameResolution", "nokiatisAccountStatus", "nokiatisAccountUuid", "id", "instancesGroupBy", "instancesGroupByAsc", "instancesSortBy", "instancesSortByAsc", "instancesTileSize", "isFirstLaunch", "javaCustomArgs", "language", "lastAppVersion", "launcherActionOnGameLaunch", "modChannels", "modPlatformBlacklist", "postExitHook", "preLaunchHook", "reducedMotion", "releaseChannel", "showAppCloseWarning", "showFeatured", "termsAndPrivacyAccepted", "termsAndPrivacyAcceptedChecksum", "theme", "wrapperCommand", "xms", "xmx" FROM "AppConfiguration";
